...
class LoginWidget(QtGui.QDialog):
    ...
    def saveData(self):
        """保存数据"""
        setting = {'userid': str(self.editUserID.text()), 'mdPassword': str(self.editMdPassword.text()),
                   'tdPassword': str(self.editTdPassword.text()), 'mdAddress': str(self.editMdAddress.text()),
                   'tdAddress': str(self.editTdAddress.text())}
