...
CSecurityFtdcTradingAccountField = {"BrokerID": "string", "AccountID": "string", "PreMortgage": "float",
									...
									"CreditRatio": "float", "FrozenExecCash": "float"}
#经纪公司代码
#投资者帐号
#上次质押金额
#上次信用额度
...
CSecurityFtdcDepthMarketDataField = {"TradingDay": "string", "InstrumentID": "string", "ExchangeID": "string",
									 ...
									 "HighestPrice": "float", "LowestPrice": "float", "Volume": "int",
									 "Turnover": "float", "OpenInterest": "float", "ClosePrice": "float",
									 "SettlementPrice": "float", "UpperLimitPrice": "float", "LowerLimitPrice": "float",
									 "PreDelta": "float", "CurrDelta": "float", "UpdateTime": "string",
									 "UpdateMillisec": "int", "BidPrice1": "float", "BidVolume1": "int",
									 "AskPrice1": "float", "AskVolume1": "int", "BidPrice2": "float",
									 "BidVolume2": "int", "AskPrice2": "float", "AskVolume2": "int",
									 "BidPrice3": "float", "BidVolume3": "int", "AskPrice3": "float",
									 "AskVolume3": "int", "BidPrice4": "float", "BidVolume4": "int",
									 "AskPrice4": "float", "AskVolume4": "int", "BidPrice5": "float",
									 "BidVolume5": "int", "AskPrice5": "float", "AskVolume5": "int",
...
CSecurityFtdcInvestorPositionDetailField = {"InstrumentID": "string", "BrokerID": "string", "InvestorID": "string",
											...
											"AccountID": "string", "PledgeInPosition": "int",
											"PledgeInFrozenPosition": "int", "RepurchasePosition": "int",
...
CSecurityFtdcExcessStockInfoField = {"BrokerID": "string", "InvestorID": "string", "ExchangeID": "string",
									 "InstrumentID": "string", "ExcessVolume": "int", "ExcessFrozenVolume": "int"}
#经纪公司代码
#投资者代码
#交易所代码
#合约代码
...
CSecurityFtdcTraderOfferField = {"ExchangeID": "string", "BranchPBU": "string", "ParticipantID": "string",
								 ...
								 "TraderConnectStatus": "string", "ConnectRequestDate": "string",
...
CSecurityFtdcMDTraderOfferField = {"ExchangeID": "string", "BranchPBU": "string", "ParticipantID": "string",
								   "Password": "string", "InstallID": "int", "OrderLocalID": "string",
								   "TraderConnectStatus": "string", "ConnectRequestDate": "string",
								   "ConnectRequestTime": "string", "LastReportDate": "string",
								   "LastReportTime": "string", "ConnectDate": "string", "ConnectTime": "string",
								   "StartDate": "string", "StartTime": "string", "TradingDay": "string",
								   "BrokerID": "string"}
#交易所代码
#交易所交易员代码
#会员代码
...
CSecurityFtdcInvestorPositionField = {"InstrumentID": "string", "BrokerID": "string", "InvestorID": "string",
									  ...
									  "PositionCost": "float", "FrozenCash": "float", "CashIn": "float",
									  "Commission": "float", "PreSettlementPrice": "float", "SettlementPrice": "float",
									  "TradingDay": "string", "OpenCost": "float", "ExchangeMargin": "float",
									  "TodayPosition": "int", "TransferFee": "float", "StampTax": "float",
									  "TodayPurRedVolume": "int", "ConversionRate": "float",
									  "ConversionAmount": "float", "StockValue": "float", "ExchangeID": "string",
									  "AccountID": "string", "PledgeInPosition": "int", "RepurchasePosition": "int",
									  "PurRedShortFrozen": "int", "MarginTradeVolume": "int",
									  "MarginTradeAmount": "float", "MarginTradeFrozenVolume": "int",
									  "MarginTradeFrozenAmount": "float", "MarginTradeConversionProfit": "float",
									  "ShortSellVolume": "int", "ShortSellAmount": "float",
									  "ShortSellFrozenVolume": "int", "ShortSellFrozenAmount": "float",
									  "ShortSellConversionProfit": "float", "SSStockValue": "float",
									  "TodayMTPosition": "int", "TodaySSPosition": "int", "YdOpenCost": "float",
									  "LockPosition": "int", "CoverPosition": "int", "LockFrozenPosition": "int",
									  "UnlockFrozenPosition": "int", "CoverFrozenPosition": "int",
									  "ExecFrozenPosition": "int"}
#合约代码
#经纪公司代码
#投资者代码
#持仓多空方向
...
CSecurityFtdcReqUserLoginField = {"TradingDay": "string", "BrokerID": "string", "UserID": "string",
								  ...
								  "ClientIPAddress": "string", "AuthCode": "string"}
#交易日
#经纪公司代码
#用户代码
#密码
...
#行情最新成交属性
CSecurityFtdcMarketDataLastMatchField = {"LastPrice": "float", "Volume": "int", "Turnover": "float",
										 "OpenInterest": "float"}
#最新价
#数量
#成交金额
...
#行情最优价属性
CSecurityFtdcMarketDataBestPriceField = {"BidPrice1": "float", "BidVolume1": "int", "AskPrice1": "float",
										 "AskVolume1": "int"}
#申买价一
#申买量一
#申卖价一
...
#行情申买二、三属性
CSecurityFtdcMarketDataBid23Field = {"BidPrice2": "float", "BidVolume2": "int", "BidPrice3": "float",
									 "BidVolume3": "int"}
#申买价二
#申买量二
#申买价三
...
#行情申卖二、三属性
CSecurityFtdcMarketDataAsk23Field = {"AskPrice2": "float", "AskVolume2": "int", "AskPrice3": "float",
									 "AskVolume3": "int"}
#申卖价二
#申卖量二
#申卖价三
...
#行情申买四、五属性
CSecurityFtdcMarketDataBid45Field = {"BidPrice4": "float", "BidVolume4": "int", "BidPrice5": "float",
									 "BidVolume5": "int"}
#申买价四
#申买量四
#申买价五
...
#行情申卖四、五属性
CSecurityFtdcMarketDataAsk45Field = {"AskPrice4": "float", "AskVolume4": "int", "AskPrice5": "float",
									 "AskVolume5": "int"}
#申卖价四
#申卖量四
#申卖价五
